...
import ConfigurationTab from './maintenance/ConfigurationTab';
...
const EspaceMaintenancePage = () => {
  ...
  const [terminalsByAgence, setTerminalsByAgence] = useState({});
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="config">
        ...
        <TabsContent value="config">
          <ConfigurationTab agences={agences} terminals={terminalsByAgence} setTerminals={setTerminalsByAgence} />
        </TabsContent>
        <TabsContent value="maintenance">
          <MaintenanceTab agences={agences} terminals={terminalsByAgence} />
        </TabsContent>
      </Tabs>
    </div>
  );
